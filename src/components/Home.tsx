...
const heroBackground = require('./resources/red-banner.png');
  ...
  render() {
    return (
      <div>
        ...
        <Row>
          <Col lg={4}>
            <img src={require('./resources/expert.png')} style={imageStyle} />
          </Col>
          <Col lg={6} lgOffset={2}>
            <Row>
              <Col md={4}>
        ...
        <Row>
          ...
          <Col lg={4} lgOffset={2}>
            <img src={require('./resources/light-bulb.png')} style={imageStyle} />
          </Col>
        </Row>
